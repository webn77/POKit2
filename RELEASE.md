...
- [x] README install commands point to the public `webn77/POKit2` repository only.
...
- Public target repository: `webn77/POKit2`
...
- [x] Public repository target confirmed: `webn77/POKit2`
