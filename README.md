...
현재 배포 대상은 stable `v0.1.0`이다. 첫 공개 후보판 `v0.1.0-rc.1` 검증 후, 같은 starter-only 공개 경계를 유지해 정식 릴리스로 승격한다.

## Quick Start

1. `pokit-starter-v0.1.0.tar.gz`를 새 프로젝트 폴더에 푼다.
...
- `LICENSE`: MIT license
- Source repository `RELEASE.md`: stable release 체크리스트와 외부 배포 경계
- Source repository `release/v0.1.0.md`: GitHub release 본문
